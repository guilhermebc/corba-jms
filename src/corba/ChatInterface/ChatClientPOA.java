...
/**
* ChatInterface/ChatClientPOA.java .
...
public abstract class ChatClientPOA extends org.omg.PortableServer.Servant
 implements ChatInterface.ChatClientOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("refresh", new java.lang.Integer (0));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // ChatInterface/ChatClient/refresh
       {
         String name = in.read_string ();
         String text = in.read_string ();
         this.refresh (name, text);
         out = $rh.createReply();
         break;
       }
