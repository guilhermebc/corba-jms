...
/**
* FriendListHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from ChatIDL.idl
* Sunday, December 3, 2017 7:42:28 PM BRT
*/

abstract public class FriendListHelper
{
  private static String  _id = "IDL:FriendList:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (FriendListHelper.id (), "FriendList", __typeCode);
    }
    return __typeCode;
  }
